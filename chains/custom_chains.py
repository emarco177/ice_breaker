...
def get_summary_chain() -> RunnableSequence:
    ...
    llm_with_structure = llm.with_structured_output(Summary)
    return summary_prompt_template | llm_with_structure
...
def get_interests_chain() -> RunnableSequence:
    ...
    llm_with_structure = llm.with_structured_output(TopicOfInterest)
    return interesting_facts_prompt_template | llm_with_structure
...
def get_ice_breaker_chain() -> RunnableSequence:
    ...
    llm_with_structure = llm_creative.with_structured_output(IceBreaker)
    return ice_breaker_prompt_template | llm_with_structure
